...
const Works: React.FC = () => {
  ...
  const worksArray = [
    ...
    { id: 1, title: "Ranch Website", img: ranchWebsiteImage, description: "A mockup site for a local farm/ranch. Features custom styling and WordPress theme building.", link:"https://ranch-website.net"},
