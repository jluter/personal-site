...
const About: React.FC<Props> = ({handleHeaderListClick}) => {
  return (
    <div className="about">
      ...
      collaborating, and exploring new opportunities.</p><p className="about__paragraph">Outside of tech, I feel passionate about the environment and tabletop gaming. Feel free to <span className="about__contact-me" onClick={() => {
